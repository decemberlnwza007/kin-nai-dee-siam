...
export default function RestaurantApp() {
  ...
  const joinQueue = (id) => {
    ...
    showToast(`รับคิว ${restaurant.name} แล้ว`);
        ...
        <>
          ...
          >
            ...
            <div className="relative z-10 w-full bg-gradient-to-t from-black/80 to-transparent p-5 pt-24 min-[900px]:p-[34px] min-[900px]:pt-32">
              <span className="mb-5 inline-flex rounded-lg bg-white px-2.5 py-2 font-bold text-ink min-[900px]:text-lg">{getWaitLabel(lead.wait)}</span>
